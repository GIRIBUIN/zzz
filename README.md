...
![Google Health](https://img.shields.io/badge/Google%20Health-4285F4?style=for-the-badge&logo=google&logoColor=white)
...
- `npm run seed-demo`가 시연용 Google Health/센서/수면/피드백 데이터를 DB에 넣습니다.
